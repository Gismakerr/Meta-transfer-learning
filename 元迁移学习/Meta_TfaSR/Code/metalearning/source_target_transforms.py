...
class RandomRotationFromSequence(object):
    ...
    def __call__(self, data):
        ...
        return F.rotate(Image.fromarray(hr), angle, self.resample, self.expand, self.center), \
                F.rotate(Image.fromarray(lr), angle, self.resample, self.expand, self.center)
