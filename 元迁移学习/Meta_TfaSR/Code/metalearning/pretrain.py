...
def train():
    ...
    #net = model.Net().to("cuda:0")
    net = mymodel.TfaSR(16, 6).to("cuda:0")
    loss_fn = nn.L1Loss()
    optimizer = optim.Adam(net.parameters(), lr=learning_rate)

    '''data'''
    datapath = r'G:\pretrain_data'
    ...
    step = 0
    with tqdm.tqdm(total=10, miniters=1, mininterval=0) as progress:
        while True:
    ...
    torch.save(net.state_dict(), r"D:\Edge_download\MZSR-pytorch-master\MZSR-pytorch-master\checkpoint/model.pth")
