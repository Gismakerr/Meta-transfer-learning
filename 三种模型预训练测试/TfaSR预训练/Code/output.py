...
parser.add_argument('--testdataroot', type=str,
                    default=r'D:\元迁移学习\实验\Data\裁剪500\Mountain',
                    help='path to dataset')
...
parser.add_argument('--outtext',type=str,
                    default=r'E:\毕业论文\图\Resnet\result.txt',
                    help='path to output')
...
with torch.no_grad():
    ...
    weight = r"D:\元迁移学习\实验\不同模型进行元迁移学习\ResNet预训练\Code\checkpoints\tfasr_1\generator_final_099.pth"
