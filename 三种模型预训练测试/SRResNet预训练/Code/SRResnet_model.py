...
class SRResNet(nn.Module):
    ...
    def __init__(self):
        ...
        #子像素卷积
        self.convPos1 = nn.Conv2d(64,256,kernel_size=3,stride=1,padding=1,padding_mode='reflect')
        #self.pixelShuffler1 = nn.PixelShuffle(1)
        self.reluPos1 = nn.PReLU()
       
        self.convPos2 = nn.Conv2d(256,64,kernel_size=3,stride=1,padding=1,padding_mode='reflect')
        #self.pixelShuffler2 = nn.PixelShuffle(1)
        self.reluPos2 = nn.PReLU()
       
        self.finConv = nn.Conv2d(64,1,kernel_size=9,padding=4,stride=1)
